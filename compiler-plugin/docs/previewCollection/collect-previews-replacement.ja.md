...
同時に hint stub の body 埋め込み (= FIR 側 [`hintAndMarkerGeneration/`](./hint-and-marker-generation.md) の続き) もこの logic 内で完結する。
...
詳細は [hint-and-marker-generation.md](./hint-and-marker-generation.md) (Part 1 — Naming) 参照。
...
詳細は [hint-and-marker-generation.md](./hint-and-marker-generation.md) (Part 2 — Hint Generation) 「ignore = true の扱い」を参照。

---

## 関連ドキュメント

- [hint-and-marker-generation.md](./hint-and-marker-generation.md) — FIR 側で emit される hint stub の全体像 (Part 2)、 marker class の役割と hint との 1:N 関係 (Part 3)、 IR 側で marker 短名から hash を復元する命名 SSoT (Part 1)
