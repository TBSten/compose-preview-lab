...
@Composable
fun PreviewLabAccordion(
    modifier: Modifier = Modifier,
    headerModifier: Modifier = Modifier,
    state: PreviewLabAccordionState = rememberPreviewLabAccordionState(),
...
@Composable
fun rememberPreviewLabAccordionState(
...
class PreviewLabAccordionGroupState(count: Int, private val allowMultipleOpen: Boolean) {
    ...
    fun getState(index: Int): PreviewLabAccordionState {
