 ...
 */
internal fun findDependentDataClasses(classDeclaration: KSClassDeclaration, logger: KSPLogger,): List<KSClassDeclaration> {
...
internal fun generateCombinedFieldForClass(
