...
internal fun CommonMenu(expanded: Boolean, onDismissRequest: () -> Unit, content: @Composable CommonMenuScope.() -> Unit) {
    ...
    if (expandedState.currentState || expandedState.targetState) {
        ...
        val popupPositionProvider =
            remember(DpOffset(0.dp, 0.dp), density) {
        ...
        Popup(
            ...
            DropdownMenuContent(
                ...
                containerColor = PreviewLabTheme.colors.background,
                content = content,
            )
        }
    }
...
private const val ClosedScaleTarget = 0.95f
...
internal object WindowAlignmentMarginPosition {
     ...
     */
    @Immutable
    data class Vertical(private val alignment: Alignment.Vertical, private val margin: Int) : MenuPosition.Vertical {
        override fun position(anchorBounds: IntRect, windowSize: IntSize, menuHeight: Int): Int {
