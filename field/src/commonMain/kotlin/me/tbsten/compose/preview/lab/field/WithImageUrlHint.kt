...
public fun MutablePreviewLabField<String>.withImageUrlHint(
    includeDummyImages: Boolean = true,
    includeInvalidImages: Boolean = true
): MutablePreviewLabField<String> = withHint(
    choices = buildMap {
