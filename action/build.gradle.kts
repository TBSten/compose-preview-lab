...
kotlin {
    ...
    js {
        outputModuleName = "compose-previewl-lab-action"
        browser()
        binaries.executable()
        binaries.library()
    ...
    listOf(
        ...
        it.binaries.framework {
            baseName = "ComposePreviewLabAction"
            isStatic = true
        }
    }
...
android {
    namespace = "me.tbsten.compose.preview.lab.action"
    compileSdk = 36
...
publishConvention {
    ...
    description =
        ...
        "action provides APIs for defining and executing custom actions in previews."
}
