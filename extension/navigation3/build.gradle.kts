...
kotlin {
    ...
    js {
        outputModuleName = "compose-preview-lab-extension-navigation3"
        browser()
        binaries.executable()
        binaries.library()
    ...
    listOf(
        ...
        it.binaries.framework {
            baseName = "ComposePreviewLabExtensionNavigation3"
            isStatic = true
        }
    }
...
android {
    namespace = "me.tbsten.compose.preview.lab.extension.navigation3"
    compileSdk = 36
