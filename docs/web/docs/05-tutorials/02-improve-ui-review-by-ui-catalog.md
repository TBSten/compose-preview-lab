...
{/* TODO: 以下のチュートリアルに従って実装したサンプルリポジトリが Github にあるため、詰まったときは参考にしてください。 */}
{/* TODO: サンプルリポジトリへのリンク */}
...
{/* TODO: GitHub Pages にデプロイするための workflow の例を追加する */}
...
{/* TODO: ワークフロー内に追加する step の例を追加する */}
...
# 適当な Composable と その Preview を追加します
