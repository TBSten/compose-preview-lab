...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/TBSten/compose-preview-lab/tree/main/docs/web/',
        },
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://tbsten.github.io/compose-preview-lab/compose-preview-lab-gallery/',
          label: 'Online Sample',
          position: 'left',
        },
        {
  ...
  staticDirectories: ["static", "../sample/build/web-static-content"],
